...
pub fn day_interval_from_date_1_test() {
  ...
  |> should.equal(day_interval.new(
    start: day.testing_iso8601("2025-02-17"),
...
pub fn day_interval_from_date_2_test() {
  ...
  |> iso_week.to_interval
  |> should.equal(day_interval.new(
    start: day.testing_iso8601("2025-04-14"),
...
pub fn day_interval_from_date_3_test() {
  day.testing_iso8601("2024-07-21")
  |> iso_week.from_day
  |> iso_week.to_interval
  |> should.equal(day_interval.new(
    start: day.testing_iso8601("2024-07-15"),
    final: day.testing_iso8601("2024-07-21"),
  ))
}
...
pub fn day_interval_from_date_4_test() {
  ...
  |> iso_week.to_interval
  |> should.equal(day_interval.new(
    start: day.testing_iso8601("2025-05-12"),
    final: day.testing_iso8601("2025-05-18"),
  ))
}
...
pub fn list_from_inside_interval_1_test() {
  day_interval.new(
    start: day.testing_iso8601("2026-03-25"),
    final: day.testing_iso8601("2026-04-05"),
  )
  |> iso_week.list_from_inside_interval
  |> list.map(iso_week.to_interval)
  |> should.equal([
    day_interval.new(
      start: day.testing_iso8601("2026-03-30"),
      final: day.testing_iso8601("2026-04-05"),
    ),
  ])
}
...
pub fn list_from_inside_interval_2_test() {
  day_interval.new(
    start: day.testing_iso8601("2026-03-25"),
    final: day.testing_iso8601("2026-03-28"),
  )
  |> iso_week.list_from_inside_interval
  |> list.map(iso_week.to_interval)
  |> should.equal([])
...
pub fn list_from_inside_interval_3_test() {
  day_interval.new(
    start: day.testing_iso8601("2026-03-23"),
    final: day.testing_iso8601("2026-03-29"),
  )
  |> iso_week.list_from_inside_interval
  |> list.map(iso_week.to_interval)
  |> should.equal([
...
pub fn list_from_inside_interval_5_test() {
  day_interval.new(
    start: day.testing_iso8601("2026-03-20"),
    final: day.testing_iso8601("2026-04-11"),
  )
  |> iso_week.list_from_inside_interval
  |> list.map(iso_week.to_interval)
  |> should.equal([
...
pub fn list_from_around_interval_5_test() {
  ...
  |> should.equal([
    day_interval.new(
      start: day.testing_iso8601("2026-03-16"),
      final: day.testing_iso8601("2026-03-22"),
    ),
    ...
    day_interval.new(
      start: day.testing_iso8601("2026-04-06"),
      final: day.testing_iso8601("2026-04-12"),
    ),
  ])
}
...
pub fn to_monday_1_test() {
  iso_week.from_day(day.testing_iso8601("2026-04-05"))
  |> iso_week.to_monday
  |> should.equal(day.testing_iso8601("2026-03-30"))
}

/// 23  24  25  26  27  28  29
/// ^^
pub fn to_monday_2_test() {
  iso_week.from_day(day.testing_iso8601("2026-03-26"))
  |> iso_week.to_monday
  |> should.equal(day.testing_iso8601("2026-03-23"))
}
...
pub fn to_list_1_test() {
  iso_week.from_day(day.testing_iso8601("2026-03-27"))
  |> iso_week.to_list
  |> should.equal(
    [
      "2026-03-23",
...
pub fn is_equal_1_test() {
  let week_a = iso_week.from_day(day.testing_iso8601("2026-03-27"))
  let week_b = iso_week.from_day(day.testing_iso8601("2026-03-27"))
...
pub fn is_equal_2_test() {
  let week_a = iso_week.from_day(day.testing_iso8601("2026-03-27"))
  let week_b = iso_week.from_day(day.testing_iso8601("2026-03-28"))
...
pub fn is_equal_3_test() {
  let week_a = iso_week.from_day(day.testing_iso8601("2026-03-27"))
  let week_b = iso_week.from_day(day.testing_iso8601("2026-02-28"))
...
pub fn compare_2_test() {
  let week_a = iso_week.from_day(day.testing_iso8601("2026-02-27"))
  let week_b = iso_week.from_day(day.testing_iso8601("2026-03-27"))
...
pub fn compare_3_test() {
  let week_a = iso_week.from_day(day.testing_iso8601("2026-04-27"))
  let week_b = iso_week.from_day(day.testing_iso8601("2026-03-27"))
