...
pub fn to_any_list_1_test() {
  calendrical.new(
    with: "whatever",
    starting_at: day.testing_iso8601("2024-07-16"),
    equality_fn: eq_func,
  )
  |> calendrical.unsafe_insert_new_current(
    with: "I'm listening to Battles",
    starting_at: day.testing_iso8601("2024-08-22"),
  )
  |> calendrical.unsafe_insert_new_current(
    with: "Fort Greene Park",
    starting_at: day.testing_iso8601("2024-09-01"),
  )
  |> calendrical.unsafe_insert_new_current(
    with: "🎸🥁",
    starting_at: day.testing_iso8601("2024-11-25"),
  )
  // ---- slice
  ...
  |> should.equal([
    Current(cal_current_variant.new(
      value: "🎸🥁",
      start: day.testing_iso8601("2024-11-25"),
    )),
    Past(cal_past_variant.new(
      value: "Fort Greene Park",
      start: day.testing_iso8601("2024-09-01"),
      final: day.testing_iso8601("2024-11-24"),
    )),
    Past(cal_past_variant.new(
      value: "I'm listening to Battles",
      start: day.testing_iso8601("2024-08-22"),
      final: day.testing_iso8601("2024-08-31"),
    )),
    Past(cal_past_variant.new(
      value: "whatever",
      start: day.testing_iso8601("2024-07-16"),
      final: day.testing_iso8601("2024-08-21"),
    )),
  ])
}
...
pub fn filter_1_test() {
  ...
  |> cal_slice.chop(day_interval.new(
    ...
    final: day.testing_iso8601("2024-11-13"),
  ))
  // ---- the actual func
  |> cal_slice.to_any_list()
  |> should.equal([
...
pub fn get_variant_by_day_1_test() {
  ...
  // ---- the actual func
  |> cal_slice.get_variant_by_day(day.testing_iso8601("2024-07-17"))
  |> should.equal(
    Past(cal_past_variant.new(
      value: "whatever",
      start: day.testing_iso8601("2024-07-16"),
...
pub fn get_variant_by_day_2_test() {
  ...
  // ---- the actual func
  |> cal_slice.get_variant_by_day(day.testing_iso8601("2024-12-01"))
  |> should.equal(
    Current(cal_current_variant.new(
      value: "🎸🥁",
      start: day.testing_iso8601("2024-11-25"),
...
pub fn get_variant_by_day_3_test() {
  ...
  // ---- the actual func
  |> cal_slice.get_variant_by_day(day.testing_iso8601("2024-09-02"))
  |> should.equal(
    Past(cal_past_variant.new(
      value: "Fort Greene Park",
      start: day.testing_iso8601("2024-09-01"),
