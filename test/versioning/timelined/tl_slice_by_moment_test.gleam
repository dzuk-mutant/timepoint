...
pub fn by_moment_medley_1_test() {
  ...
  |> timelined.slice_by_moment_interval(moment_interval.new(
    start: moment.testing_rfc3339("2024-07-01T00:00:00.000Z"),
    end_excluding: moment.testing_rfc3339("2025-08-05T00:00:00.000Z"),
  ))
  // ---- the actual func
...
pub fn by_moment_medley_2_test() {
  ...
  |> timelined.slice_by_moment_interval(moment_interval.new(
    start: moment.testing_rfc3339("2024-07-01T00:00:00.000Z"),
    end_excluding: moment.testing_rfc3339("2024-08-05T00:00:00.000Z"),
  ))
  // ---- the actual func
  |> tl_slice_by_moment.to_any_list()
  |> should.equal([
...
pub fn by_moment_medley_3_test() {
  ...
  // ---- slice
  |> timelined.slice_by_moment_interval(moment_interval.new(
    start: moment.testing_rfc3339("2025-07-01T00:00:00.000Z"),
    end_excluding: moment.testing_rfc3339("2025-08-05T00:00:00.000Z"),
  ))
  // ---- the actual func
  |> tl_slice_by_moment.to_any_list()
...
pub fn by_moment_medley_4_test() {
  ...
  |> tl_slice_by_moment.chop(moment_interval.new(
    start: moment.testing_rfc3339("2024-08-30T00:00:00.000Z"),
    end_excluding: moment.testing_rfc3339("2024-10-30T00:00:00.000Z"),
  ))
  // ---- the actual func
  |> tl_slice_by_moment.to_any_list()
  |> should.equal([
...
pub fn by_moment_medley_5_test() {
  ...
  |> tl_slice_by_moment.chop(moment_interval.new(
    start: moment.testing_rfc3339("2010-08-30T00:00:00.000Z"),
    end_excluding: moment.testing_rfc3339("2010-10-30T00:00:00.000Z"),
  ))
  // ---- the actual func
  |> tl_slice_by_moment.to_any_list()
  |> should.equal([])
